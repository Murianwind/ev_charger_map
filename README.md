...
### 시설 구분(kindDetail) 전체 카테고리와 제외 목록

가이드 문서 기준 `kind`(대분류) 10개, `kindDetail`(상세분류) 47개가 있습니다.
이 중 **일반인이 자유롭게 접근하기 어려운 20개 카테고리**를 제외합니다
(`scripts/gov_charger_api.py`의 `EXCLUDED_KIND_DETAILS`).

| kind(대분류) | kindDetail(상세) | 제외 여부 |
|---|---|---|
| A0 공공시설 | A001 관공서 | |
| | A002 주민센터 | |
| | A003 공공기관 | |
...
| | **G005 오피스텔** | ✅ 제외 |
| | **G006 단독주택** | ✅ 제외 |
| H0 공동주택시설 | **H001 아파트** | ✅ 제외 |
| | **H002 빌라** | ✅ 제외 |
| | **H003 사업장(사옥)** | ✅ 제외 |
| | **H004 기숙사** | ✅ 제외 |
| | **H005 연립주택** | ✅ 제외 |
| I0 근린생활시설 | **I001 병원** | ✅ 제외 |
| | **I002 종교시설** | ✅ 제외 |
| | I003 보건소 | |
| | **I004 경찰서** | ✅ 제외 |
| | I005 도서관 | |
...
**제외 근거**: H0(공동주택시설) 전체와 G005/G006은 거주자 전용일 가능성이
높은 주거시설, H003은 특정 회사 직원 전용, G001은 민간인 접근 불가,
I001/I002/I004/I006/I007/I008은 소속·방문객 전용이거나 일반 주차 목적이
아닌 경우가 많음, J001~J003은 재학생·수강생 전용일 가능성이 높음, E004는
회원 전용인 경우가 많음, F001/F002는 정비 고객 전용이라 일반 주차 목적이
아님 — 이라는 판단입니다. 실제 데이터에서 예외(예: 완전 개방된 오피스텔
충전기)가 있을 수 있어, 필요하면 `EXCLUDED_KIND_DETAILS`만 조정하면 됩니다.
