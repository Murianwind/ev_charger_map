...
NON_OPEN_KEYWORDS = ("비개방", "불가", "금지", "외부인", "입주민", "거주자", "제한될 수", "내방객", "제한됨", "보안구역",)
...
RESTRICTED_NAME_KEYWORDS = ("교도소", "구치소", "소년원", "보호관찰소", "경찰서", "파출소", "장례", "소방서", "검찰", "법원", "119")

# 가이드 문서 공식 zcode(시도 코드) 표. 전국을 매번 한 번에 스캔하면 하루 API
# 호출 한도(1,000건)를 계속 위태롭게 넘나들게 되어, 요일별로 나눠 담당한다.ㅁ
